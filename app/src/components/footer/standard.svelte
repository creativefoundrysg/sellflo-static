...
<footer class="mx-auto max-w-7xl px-6 w-full">
    <div class="mx-auto max-w-2xl lg:max-w-none pb-4">
        <div class="flex flex-wrap items-center justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-8">
            <a onclick={() => {
                trackEvent({
            ...
            }} data-sveltekit-reload class="relative" aria-label="Home" href="/">
            ...
            <div class="flex items-center gap-x-6 text-zinc-400 text-xs">   
                <div class="flex flex-col gap-y-2 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-6">
                    <a onclick={() => {
                        trackEvent({
                            category: 'Funnel: Awareness',
                ...
                <div class="flex flex-col gap-y-2 sm:inline-flex sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-6">
                    <a onclick={() => {
                        trackEvent({
                            category: 'Funnel: Awareness',
