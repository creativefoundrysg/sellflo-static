...
export async function load({ cookies, url }) {
	...
	const variants = [
		...
		{ variant: 3, title: '5x your Leads in 30 days.', description: 'Fast, instant HIGH CONVERTING Landing Pages.' },
		{ variant: 4, title: 'Let AI get your next Lead in 7 days.', description: 'Just one prompt. Fully built, optimized, and deployed.' },
	...
	let disclaimerText = `<span class="font-bold text-zinc-500">Disclaimer: </span>The extent of cost reduction, time-to-market acceleration, SEO benefits, lead generation, enhanced customization, flexibility and other features may vary depending on the specific requirements, existing infrastructure, and operational strategies of each organization. While we strive to deliver consistent results, individual outcomes are not guaranteed in any way and are influenced by multiple factors.
